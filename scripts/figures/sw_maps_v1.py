...
fig.suptitle(
    "firescape statewide v1 — pre-fire postfire-debris-flow hazard, Nevada (v1)\n"
    f"{len(basins):,} basins · 591 HU10 watersheds · Nevada-refit CDFs · "
    "per-region calibration (123 era-matched fires) · SSURGO soils · "
    "blue = Bug and Stallion fires", y=0.99, fontsize=13)
fig.tight_layout()
mc.save(fig, "statewide_v1_hazard")
