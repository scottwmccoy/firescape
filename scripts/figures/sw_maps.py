...
fig.suptitle(
    "firescape statewide v0 — pre-fire postfire-debris-flow hazard, Nevada (PROVISIONAL)\n"
    f"{len(basins):,} basins · 591 HU10 watersheds · Nevada-refit CDFs · "
    "pilot calibration applied statewide (P$_{dsim}$=0.51) · SSURGO soils · "
    "blue = Bug and Stallion fires", y=0.99, fontsize=13)
fig.tight_layout()
mc.save(fig, "statewide_v0_hazard")
