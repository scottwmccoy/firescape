...
basins = read_dataframe(OUT / "statewide_v1_1_basins.gpkg",
...
fig.suptitle(
    "firescape statewide v1.1 — pre-fire postfire-debris-flow hazard, Nevada\n"
...
fig.tight_layout()
mc.save(fig, "statewide_v1_1_hazard")
