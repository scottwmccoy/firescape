...
merged = OUT / "statewide_v0_basins.gpkg"
...
summary = {
    ...
    "calibration": "pilot_v2 applied statewide (PROVISIONAL v0)",
    "cdf_table": "nv_merged",
    ...
    "seam_fix": ("2026-08-13: statewide._mosaic_to_grid nodata-collar fix "
                 "(rasterio 1.5 int-path init); 295 EVT-poisoned units re-run"),
}
(OUT / "statewide_v0_summary.json").write_text(json.dumps(summary, indent=2))
