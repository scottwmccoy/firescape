"""Dolan re-scored on WorldView-2: does 2 m + 8-band beat 3 m PlanetScope?
...
fig.tight_layout()
fig.savefig(OUT / "dolan_wv_chip.png", bbox_inches="tight")
plt.close(fig)

summary = {
    "pre": "2020-11-29 WV02 x5 M2AS", "post": "2021-04-19 WV02 x3 M2AS",
...
(OUT / "dolan_wv_summary.json").write_text(json.dumps(summary, indent=2))
